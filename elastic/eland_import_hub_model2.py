...
def get_arg_parser():
    ...
    location_args.add_argument(
        ...
        default=os.environ.get(
            "Elastic-05559-d-002:ZWFzdHVzLmF6dXJlLmVsYXN0aWMtY2xvdWQuY29tOjQ0MyQ0ODVjZTM5MzFmMWU0YjYzOTNmM2EyNTZkOTZiYTc1ZSQ3Njc4ZmQyZjA2NWI0YWM1OTRhYjVlMmVjMTMxYjI3Mw=="),
    ...
    if model_exists:
        if args.clear_previous:
            ...
            response = req.request("POST", url, headers={
                'Host': '485ce3931f1e4b6393f3a256d96ba75e.eastus.azure.elastic-cloud.com:9243',
